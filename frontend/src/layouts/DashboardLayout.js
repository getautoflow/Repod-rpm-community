  ...
  return (
    <div className="flex h-screen bg-slate-100 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Upgrade banner */}
        <div className="shrink-0 flex items-center justify-between gap-4 px-6 py-2 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200">
          <div className="flex items-center gap-2 min-w-0">
            <svg className="w-3.5 h-3.5 text-amber-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
